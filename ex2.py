...
Estratégias:
1. Tabuleiro: O tabuleiro é representado como uma matriz de tamanho personalizável, onde "-" representa uma célula vazia, "X" representa uma jogada do jogador X e "O" representa uma jogada do jogador O.
...
elements = ("X", "O")
size = int(input("Qual o tamanho do campo? "))
player = 0
